...
ZTEST_SUITE_BEGIN( ScopedSharedLock_TestSuite )
...
ZTEST_CASE ( Constructor_OwnsTheMutexWhenItWasNotLockedAndInputIsTrue_Test )
{
    ...
    // [Execution]
    ScopedSharedLock<SharedMutex> lock(mutex, INPUT_VALUE);
...
ZTEST_CASE ( Destructor_MutexIsUnlocked_Test )
{
    ...
    SharedMutex mutex;
    {
        ScopedSharedLock<SharedMutex> lock(mutex, true);
...
ZTEST_CASE ( Destructor_ItDoesNothingWhenMutexIsNotLocked_Test )
{
    ...
    SharedMutex mutex;
    {
        ScopedSharedLock<SharedMutex> lock(mutex, false);
...
// End - Test Suite: ScopedSharedLock
ZTEST_SUITE_END()
