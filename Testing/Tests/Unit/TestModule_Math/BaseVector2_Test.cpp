...
ZTEST_SUITE_BEGIN( BaseVector2_TestSuite )
...
ZTEST_CASE ( Constructor2_ValuesAreCopiedProperly_Test )
{
    ...
    const BaseVector2 VECTOR_TO_COPY(EXPECTED_VALUE_FOR_X, EXPECTED_VALUE_FOR_Y);

	// [Execution]
    BaseVector2 vVectorUT = VECTOR_TO_COPY;
...
ZTEST_CASE ( Constructor3_ValuesAreSetProperly_Test )
{
	...
	// [Execution]
    BaseVector2 vVectorUT(EXPECTED_VALUE_FOR_X, EXPECTED_VALUE_FOR_Y);
...
ZTEST_CASE ( Constructor4_ValueIsSetForAllComponents_Test )
{
	...
	// [Execution]
    BaseVector2 vVectorUT(EXPECTED_VALUE_FOR_ALL);
...
/// </summary>
ZTEST_CASE ( Constructor5_VectorComponentsAreFilledWithValidReferenceTo2Floats_Test )
{
    // [Preparation]
    const float_z EXPECTED_VALUE_FOR_X = SFloat::_1;
    const float_z EXPECTED_VALUE_FOR_Y = SFloat::_2;
	...
	// [Execution]
    BaseVector2 vVectorUT(VALID_ARRAY_OF_2_FLOATS);
...
ZTEST_CASE ( Constructor5_AssertionFailsWhenPointerIsNull_Test )
{
    ...
    try
    {
        BaseVector2 vVectorUT(NULL_ARRAY);
    }
...
{
    // [Preparation]
    const BaseVector2 LEFT_OPERAND(SFloat::Epsilon);
    const BaseVector2 RIGHT_OPERAND(SFloat::_0);
...
{
    // [Preparation]
    const BaseVector2 LEFT_OPERAND(SFloat::Epsilon - SFloat::Epsilon * SFloat::_0_5);
    const BaseVector2 RIGHT_OPERAND(SFloat::_0);
...
ZTEST_CASE ( OperatorEquality_TrueWhenOperandsAreExactlyEqual_Test )
{
    // [Preparation]
    const BaseVector2 LEFT_OPERAND(SFloat::Epsilon);
    const BaseVector2 RIGHT_OPERAND(SFloat::Epsilon);
