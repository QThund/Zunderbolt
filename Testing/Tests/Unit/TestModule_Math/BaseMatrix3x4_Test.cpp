...
ZTEST_SUITE_BEGIN( BaseMatrix3x4_TestSuite )
...
ZTEST_CASE ( Constructor2_EveryMatrixElementCopiedProperly_Test )
{
	...
	// [Execution]
    const BaseMatrix3x4 MATRIX_TO_COPY(EXPECTED_VALUE_FOR_00, EXPECTED_VALUE_FOR_01, EXPECTED_VALUE_FOR_02, EXPECTED_VALUE_FOR_03,
    ...
    // [Execution]
    BaseMatrix3x4 matrixUT = MATRIX_TO_COPY;
...
ZTEST_CASE ( Constructor3_ValueIsSetForAllComponents_Test )
{
    ...
    BaseMatrix3x4 matrixUT(EXPECTED_VALUE_FOR_ALL);
...
ZTEST_CASE ( Constructor4_ValuesAreSetProperly_Test )
{
   // [Preparation]
	...
	// [Execution]
    BaseMatrix3x4 matrixUT(EXPECTED_VALUE_FOR_00, EXPECTED_VALUE_FOR_01, EXPECTED_VALUE_FOR_02, EXPECTED_VALUE_FOR_03,
                            EXPECTED_VALUE_FOR_10, EXPECTED_VALUE_FOR_11, EXPECTED_VALUE_FOR_12, EXPECTED_VALUE_FOR_13,
                            EXPECTED_VALUE_FOR_20, EXPECTED_VALUE_FOR_21, EXPECTED_VALUE_FOR_22, EXPECTED_VALUE_FOR_23);
...
ZTEST_CASE ( Constructor5_MatrixComponentsAreFilledWithValidReferenceTo12Floats_Test )
{
   // [Preparation]
	...
	// [Execution]
    BaseMatrix3x4 matrixUT(VALID_ARRAY_OF_12_FLOATS);
...
ZTEST_CASE ( Constructor5_AssertionFailsWhenPointerIsNull_Test )
{
    ...
    try
    {
        BaseMatrix3x4 vMatrixUT(NULL_ARRAY);
    }
...
ZTEST_CASE ( Constructor6_MatrixComponentsAreSetToValidVF32PackedValues_Test )
{
	...
	// [Execution]
	BaseMatrix3x4 matrixUT(PACK0, PACK1, PACK2);
...
{
    // [Preparation]
    const BaseMatrix3x4 LEFT_OPERAND(SFloat::Epsilon);
    const BaseMatrix3x4 RIGHT_OPERAND(SFloat::_0);
...
ZTEST_CASE ( OperatorEquality_TrueWhenOperandsDifferLessThanTolerance_Test )
{
    ...
    const BaseMatrix3x4 LEFT_OPERAND(HALF_TOLERANCE);
    const BaseMatrix3x4 RIGHT_OPERAND(SFloat::_0);
...
ZTEST_CASE ( OperatorEquality_FalseWhenOperandsDifferGreaterThanTolerance_Test )
{
    ...
    const BaseMatrix3x4 LEFT_OPERAND(ONE_AND_A_HALF_TOLERANCE);
    const BaseMatrix3x4 RIGHT_OPERAND(SFloat::_0);
...
{
    // [Preparation]
    const BaseMatrix3x4 LEFT_OPERAND(SFloat::_1, SFloat::_2, SFloat::_3,
                                      SFloat::_4, SFloat::_5, SFloat::_6,
                                      SFloat::_7, SFloat::_8, SFloat::_9,
                                      SFloat::_10, SFloat::_10 + SFloat::_1, SFloat::_10 + SFloat::_2);

    const BaseMatrix3x4 RIGHT_OPERAND(SFloat::_1, SFloat::_2, SFloat::_3,
                                       SFloat::_4, SFloat::_5, SFloat::_6,
                                       SFloat::_7, SFloat::_8, SFloat::_9,
                                       SFloat::_10, SFloat::_10 + SFloat::_1, SFloat::_10 + SFloat::_2);
