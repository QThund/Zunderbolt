...
ZTEST_SUITE_BEGIN( SEqualityComparator_TestSuite )
...
ZTEST_CASE ( Compare_ReturnsPositiveOneWhenLeftOperandIsGreaterThanRightOperand_Test )
{
    ...
    // [Execution]
    i8_z comparisonResult = SEqualityComparator<const i8_z&>::Compare(LEFT_OPERAND, RIGHT_OPERAND);
...
/// </summary>
ZTEST_CASE ( Compare_ReturnsPositiveOneWhenLeftOperandIsLowerThanRightOperand_Test )
{
    // [Preparation]
    const i8_z EXPECTED_VALUE_OF_COMPARISON = 1;
...
// End - Test Suite: SEqualityComparator
ZTEST_SUITE_END()
