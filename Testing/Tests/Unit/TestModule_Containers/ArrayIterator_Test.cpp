...
ZTEST_SUITE_BEGIN( ArrayIterator_TestSuite )
...
ZTEST_CASE ( Constructor_IteratorPointsToGivenPositionWhenUsingCommonArray_Test )
{
    ...
    ArrayFixed<int>::ArrayIterator EXPECTED_ITERATOR(&SOURCE_ARRAY, 0);
    EXPECTED_ITERATOR.MoveFirst();
    ++EXPECTED_ITERATOR;

	// [Execution]
    ArrayFixed<int>::ArrayIterator iterator(&SOURCE_ARRAY, POSITION);
...
ZTEST_CASE ( Constructor_IteratorPointsToForwardEndPositionWhenUsingEmptyArray_Test )
{
	...
	// [Execution]
    ArrayDynamic<int>::ArrayIterator iterator(&SOURCE_ARRAY, 0);
...
ZTEST_CASE ( OperatorIndirection_ReturnsTheCorrespondingElement_Test )
{
    ...
    ArrayFixed<int>::ArrayIterator ITERATOR(&SOURCE_ARRAY, 0);
    ITERATOR++;
...
ZTEST_CASE ( OperatorDereferencing_ReturnsTheCorrespondingElement_Test )
{
    ...
    ArrayFixed<TestStructure>::ArrayIterator ITERATOR(&SOURCE_ARRAY, 0);
    ITERATOR++;
...
ZTEST_CASE ( OperatorPostIncrement_CommonIteratorStepsForwardProperlyAndReturnsPreviousState_Test )
{
    ...
    ArrayFixed<int>::ArrayIterator ORIGINAL_ITERATOR(&SOURCE_ARRAY, 0);
    ORIGINAL_ITERATOR.MoveFirst();

	// [Execution]
    ArrayFixed<int>::ArrayIterator iterator(ORIGINAL_ITERATOR);
    ArrayFixed<int>::ArrayIterator iteratorPreviousState = iterator++;
...
ZTEST_CASE ( OperatorPostIncrement_AssertionFailsWhenIteratorAlreadyPointsToLastEndPosition_Test )
{
    // [Preparation]
    ArrayFixed<int> SOURCE_ARRAY(3, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_END(&SOURCE_ARRAY, 0);
...
ZTEST_CASE ( OperatorPostIncrement_IteratorChangesWhenItAlreadyPointsToLastEndPosition_Test )
{
	...
	// [Execution]
    ArrayFixed<int>::ArrayIterator iterator(ITERATOR_END);
    iterator++;
...
ZTEST_CASE ( OperatorPreIncrement_CommonIteratorStepsForwardProperlyAndReturnsCurrentState_Test )
{
	...
	// [Execution]
    ArrayFixed<int>::ArrayIterator iterator(ORIGINAL_ITERATOR);
    ArrayFixed<int>::ArrayIterator iteratorCurrentState = ++iterator;
...
ZTEST_CASE ( OperatorAssignment_CommonIteratorIsCorrectlyCopied_Test )
{
    // [Preparation]
    ArrayFixed<int> SOURCE_ARRAY(3, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_A(&SOURCE_ARRAY, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_B(&SOURCE_ARRAY, 0);

	// [Execution]
    ArrayFixed<int>::ArrayIterator iterator = ITERATOR_B;
    iterator = ITERATOR_A;
...
ZTEST_CASE ( OperatorAssignment_AssertionFailsWhenInputIteratorPointsToDifferentArray_Test )
{
    ...
    ArrayFixed<int>::ArrayIterator ITERATOR_A(&ARRAY_A, 0);
    ...
    try
    {
        ArrayFixed<int>::ArrayIterator iterator(&ARRAY_B, 0);
        iterator = ITERATOR_A;
    }
    catch(const AssertException&)
    {
...
ZTEST_CASE ( OperatorAssignment_IteratorDoesNotChangeIfInputIteratorPointsToDifferentArray_Test )
{
    ...
    ArrayFixed<int> ARRAY_B(3, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_A(&ARRAY_A, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_B(&ARRAY_B, 0);
...
ZTEST_CASE ( MoveFirst_IteratorPointsToFirstPositionWhenArrayIsNotEmpty_Test )
{
    ...
    ++ORIGINAL_ITERATOR;
    ++ORIGINAL_ITERATOR;
    ArrayFixed<int>::ArrayIterator ITERATOR_FIRST(&SOURCE_ARRAY, 0);
...
ZTEST_CASE ( MoveFirst_AssertionFailsWhenArrayIsEmpty_Test )
{
    ...
    EMPTY_ARRAY.Add(0);
    ArrayFixed<int>::ArrayIterator ITERATOR(&EMPTY_ARRAY, 0);
...
ZTEST_CASE ( MoveFirst_IteratorPointsToEndPositionWhenArrayIsEmpty_Test )
{
    // [Preparation]
    ArrayDynamic<int> EMPTY_ARRAY;
    ArrayFixed<int>::ArrayIterator END_ITERATOR(&EMPTY_ARRAY, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR(&EMPTY_ARRAY, 0);
...
ZTEST_CASE ( MoveLast_IteratorPointsToLastPositionWhenArrayIsNotEmpty_Test )
{
    ...
    ArrayFixed<int> SOURCE_ARRAY(3, 0);
    ArrayFixed<int>::ArrayIterator ORIGINAL_ITERATOR(&SOURCE_ARRAY, 0);
    ArrayFixed<int>::ArrayIterator ITERATOR_LAST(&SOURCE_ARRAY, 0);
    ++ITERATOR_LAST;
    ++ITERATOR_LAST;
...
ZTEST_CASE ( MoveForward_CommonIteratorIsCorrectlyIncrementedWhenIncrementIsGreaterThanZero_Test )
{
    ...
    ArrayFixed<int>::ArrayIterator iterator(&arSourceArray, 0);
    iterator.MoveFirst();
