...
#ifndef __ETESTTYPE__
#define __ETESTTYPE__
...
public:
    ...
    enum EnumType
    {
        E_UnitTest = Z_ENUMERATION_MIN_VALUE ,/*!< Unit test. */
...
public:
    ...
    ETestType(const ETestType::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    ETestType(const enum_int_z nValue) : m_value(scast_z(nValue, const ETestType::EnumType))
    {
    }
    ...
    ETestType(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    ETestType(const ETestType &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    ETestType& operator=(const enum_int_z nValue)
    {
        m_value = scast_z(nValue, const ETestType::EnumType);
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    ETestType& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < ETestType::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        Z_ASSERT_ERROR(uEnumStringIndex < ETestType::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    ETestType& operator=(const ETestType::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    ETestType& operator=(const ETestType &eValue)
    {
    ...
    /// </returns>
    bool operator==(const ETestType &eValue) const
    {
    ...
    {
        return m_value == scast_z(nValue, const ETestType::EnumType);
    }
    ...
    /// </returns>
    bool operator==(const ETestType::EnumType eValue) const
    {
    ...
    {
        static const ArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, ETestType::_GetNumberOfValues());
    ...
    /// </returns>
    operator ETestType::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const ETestType::EnumType eValue)
    {
        Z_ASSERT_ERROR(scast_z(eValue, unsigned int) < ETestType::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const ETestType::EnumType sm_arValues[];

    /// <summary>
    /// The contained enumeration value.
    /// </summary>
    ETestType::EnumType m_value;
