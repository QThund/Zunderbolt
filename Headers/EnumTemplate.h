...
#ifndef __EENUMERATION__
#define __EENUMERATION__
...
/// [DOC]
/// </summary>
class Z_LAYER_<LAYER_NAME>_SYMBOLS EEnumeration
{
    // ENUMERATIONS
    // ---------------
public:
    ...
    enum EnumType
    {
        E_<> = Z_ENUMERATION_MIN_VALUE, /*!< [DOC] */
        , /*!< [DOC] */
...
public:
    ...
    EEnumeration(const EEnumeration::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EEnumeration(const enum_int_z nValue) : m_value(scast_z(nValue, const EEnumeration::EnumType))
    {
    }
    ...
    EEnumeration(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EEnumeration(const EEnumeration &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EEnumeration& operator=(const enum_int_z nValue)
    {
        m_value = scast_z(nValue, const EEnumeration::EnumType);
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EEnumeration& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EEnumeration::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        Z_ASSERT_ERROR(uEnumStringIndex < EEnumeration::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EEnumeration& operator=(const EEnumeration::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EEnumeration& operator=(const EEnumeration &eValue)
    {
    ...
    /// </returns>
    bool operator==(const EEnumeration &eValue) const
    {
    ...
    {
        return m_value == scast_z(nValue, const EEnumeration::EnumType);
    }
    ...
    /// </returns>
    bool operator==(const EEnumeration::EnumType eValue) const
    {
    ...
    {
        static const ArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EEnumeration::_GetNumberOfValues());
    ...
    /// </returns>
    operator EEnumeration::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EEnumeration::EnumType eValue)
    {
        Z_ASSERT_ERROR(scast_z(eValue, unsigned int) < EEnumeration::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EEnumeration::EnumType sm_arValues[];

    /// <summary>
    /// The contained enumeration value.
    /// </summary>
    EEnumeration::EnumType m_value;
...
const char* EEnumeration::sm_arStrings[] = { <"">,
                                              <"">};

const EEnumeration::EnumType EEnumeration::sm_arValues[] = { EEnumeration::<>,
                                                               EEnumeration::<>};
...
unsigned int EEnumeration::_GetNumberOfValues()
{
    return sizeof(sm_arValues) / sizeof(EEnumeration::EnumType);
}
