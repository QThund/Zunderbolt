...
// to import the symbols of all the Zunderbolt libraries linked.
    ...
    #define Z_LAYER_DIAGNOSIS_SYMBOLS Z_EXPORT_SYMBOLS
    #define Z_LAYER_DIAGNOSIS_EXTERN Z_EXPORT_SYMBOLS_EXTERN
    #define Z_DIAGNOSIS_TEMPLATE_SPECIALIZATION_SYMBOLS
    ...
    #define Z_LAYER_DIAGNOSIS_SYMBOLS Z_IMPORT_SYMBOLS
    #define Z_LAYER_DIAGNOSIS_EXTERN Z_IMPORT_SYMBOLS_EXTERN
    #define Z_DIAGNOSIS_TEMPLATE_SPECIALIZATION_SYMBOLS
#else // Static library
    #define Z_LAYER_DIAGNOSIS_SYMBOLS
    #define Z_LAYER_DIAGNOSIS_EXTERN
#endif
