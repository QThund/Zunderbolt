...
#ifndef __TYPEWITHGETTYPE__
#define __TYPEWITHGETTYPE__
...
/// a static method called GetTypeClass, which receive no parameters and return a pointer to a Type instance.<br/>
...
/// </summary>
class Z_DIAGNOSIS_MODULE_SYMBOLS TypeWithGetType
{
};
