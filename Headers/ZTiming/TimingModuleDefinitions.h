...
// to import the symbols of all the Zunderbolt libraries linked.
    ...
    #define Z_TIMING_MODULE_SYMBOLS Z_EXPORT_SYMBOLS
    #define Z_TIMING_MODULE_EXTERN Z_EXPORT_SYMBOLS_EXTERN
    #define Z_TIMING_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_TIMING_MODULE_IS_DYNAMIC 1
    ...
    #define Z_TIMING_MODULE_SYMBOLS Z_IMPORT_SYMBOLS
    #define Z_TIMING_MODULE_EXTERN Z_IMPORT_SYMBOLS_EXTERN
    #define Z_TIMING_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_TIMING_MODULE_IS_DYNAMIC 1
#else // Static library
    #define Z_TIMING_MODULE_SYMBOLS
    #define Z_TIMING_MODULE_EXTERN
    #define Z_TIMING_MODULE_IS_STATIC 1
#endif
