...
#ifndef __ZTHREADINGMODULEDEFINITIONS__
#define __ZTHREADINGMODULEDEFINITIONS__
...
#ifdef Z_PREPROCESSOR_EXPORTLIB_THREADING // Specified as a preprocessor definition when compiling as a dynamic link library
    #define Z_THREADING_MODULE_SYMBOLS Z_EXPORT_SYMBOLS
    #define Z_THREADING_MODULE_EXTERN Z_EXPORT_SYMBOLS_EXTERN
    #define Z_THREADING_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_THREADING_MODULE_IS_DYNAMIC 1
#elif defined(Z_PREPROCESSOR_IMPORTLIB_THREADING) || defined(Z_PREPROCESSOR_IMPORTLIB_ZUNDERBOLT) // Specified as a preprocessor definition when compiling the client system
    #define Z_THREADING_MODULE_SYMBOLS Z_IMPORT_SYMBOLS
    #define Z_THREADING_MODULE_EXTERN Z_IMPORT_SYMBOLS_EXTERN
    #define Z_THREADING_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_THREADING_MODULE_IS_DYNAMIC 1
#else // Static library
    #define Z_THREADING_MODULE_SYMBOLS
    #define Z_THREADING_MODULE_EXTERN
    #define Z_THREADING_MODULE_IS_STATIC 1
#endif


#endif // __ZTHREADINGMODULEDEFINITIONS__
