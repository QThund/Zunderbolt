...
#ifndef __EFILEOPENMODE__
#define __EFILEOPENMODE__
...
public:
    ...
    enum EnumType
    {
        E_Append = Z_ENUMERATION_MIN_VALUE, /*!< The file is opened, if it exists, and the position pointer of the stream is set to the end. If the file does not exist, an error will occur. */
...
public:
    ...
    EFileOpenMode(const EFileOpenMode::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    EFileOpenMode(const enum_int_z nValue) : m_value(scast_z(nValue, const EFileOpenMode::EnumType))
    {
    }
    ...
    EFileOpenMode(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    EFileOpenMode(const EFileOpenMode &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    EFileOpenMode& operator=(const enum_int_z nValue)
    {
        m_value = scast_z(nValue, const EFileOpenMode::EnumType);
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EFileOpenMode& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < EFileOpenMode::_GetNumberOfValues())
        {
            bMatchFound = strcmp(sm_arStrings[uEnumStringIndex], szValueName) == 0;
            ++uEnumStringIndex;
        }

        Z_ASSERT_ERROR(uEnumStringIndex < EFileOpenMode::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    EFileOpenMode& operator=(const EFileOpenMode::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    EFileOpenMode& operator=(const EFileOpenMode &eValue)
    {
    ...
    /// </returns>
    bool operator==(const EFileOpenMode &eValue) const
    {
    ...
    {
        return m_value == scast_z(nValue, const EFileOpenMode::EnumType);
    }
    ...
    /// </returns>
    bool operator==(const EFileOpenMode::EnumType eValue) const
    {
    ...
    {
        static const ArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, EFileOpenMode::_GetNumberOfValues());
    ...
    /// </returns>
    operator EFileOpenMode::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const EFileOpenMode::EnumType eValue)
    {
        Z_ASSERT_ERROR(scast_z(eValue, unsigned int) < EFileOpenMode::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const EFileOpenMode::EnumType sm_arValues[];

    /// <summary>
    /// The contained enumeration value.
    /// </summary>
    EFileOpenMode::EnumType m_value;
