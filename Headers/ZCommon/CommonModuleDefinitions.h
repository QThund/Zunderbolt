...
// to import the symbols of all the Zunderbolt libraries linked.
    ...
    #define Z_LAYER_COMMON_SYMBOLS Z_EXPORT_SYMBOLS
    #define Z_LAYER_COMMON_EXTERN Z_EXPORT_SYMBOLS_EXTERN
    #define Z_COMMON_TEMPLATE_SPECIALIZATION_SYMBOLS
    ...
    #define Z_LAYER_COMMON_SYMBOLS Z_IMPORT_SYMBOLS
    #define Z_LAYER_COMMON_EXTERN Z_IMPORT_SYMBOLS_EXTERN
    #define Z_COMMON_TEMPLATE_SPECIALIZATION_SYMBOLS
#else // Static library
    #define Z_LAYER_COMMON_SYMBOLS
    #define Z_LAYER_COMMON_EXTERN
#endif
