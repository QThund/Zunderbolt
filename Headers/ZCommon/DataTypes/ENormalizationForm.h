...
#ifndef __ENORMALIZATIONFORM__
#define __ENORMALIZATIONFORM__
...
public:
    ...
    enum EnumType
    {
        E_C = Z_ENUMERATION_MIN_VALUE, /*!< Canonical decomposition followed by canonical composition (NFC). */
...
public:
    ...
    ENormalizationForm(const ENormalizationForm::EnumType eValue) : m_value(eValue)
    {
    }
    ...
    ENormalizationForm(const enum_int_z nValue) : m_value(scast_z(nValue, const ENormalizationForm::EnumType))
    {
    }
    ...
    ENormalizationForm(const char* szValueName)
    {
        *this = szValueName;
    }
    ...
    ENormalizationForm(const ENormalizationForm &eValue) : m_value(eValue.m_value)
    {
    }
    ...
    /// </returns>
    ENormalizationForm& operator=(const enum_int_z nValue)
    {
        m_value = scast_z(nValue, const ENormalizationForm::EnumType);
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    ENormalizationForm& operator=(const char* szValueName)
    {
        bool bMatchFound = false;
        unsigned int uEnumStringIndex = 0;

        while(!bMatchFound && uEnumStringIndex < ENormalizationForm::_GetNumberOfValues())
        {
        ...
        //Z_ASSERT_ERROR(uEnumStringIndex < ENormalizationForm::_GetNumberOfValues(), "The input string does not correspond to any valid enumeration value.");
    ...
    /// The enumerated type itself.
    /// </returns>
    ENormalizationForm& operator=(const ENormalizationForm::EnumType eValue)
    {
        m_value = eValue;
        return *this;
    }
    ...
    /// The enumerated type itself.
    /// </returns>
    ENormalizationForm& operator=(const ENormalizationForm &eValue)
    {
    ...
    /// </returns>
    bool operator==(const ENormalizationForm &eValue) const
    {
    ...
    {
        return m_value == scast_z(nValue, const ENormalizationForm::EnumType);
    }
    ...
    /// </returns>
    bool operator==(const ENormalizationForm::EnumType eValue) const
    {
    ...
    {
        static const ArrayBasic<const EnumType> ARRAY_OF_VALUES(sm_arValues, ENormalizationForm::_GetNumberOfValues());
    ...
    /// </returns>
    operator ENormalizationForm::EnumType() const
    {
        return m_value;
    }
...
private:
    ...
    /// </returns>
    inline static const char* _ConvertToString(const ENormalizationForm::EnumType eValue)
    {
        // Commented to avoid a mutual inclusion with assertions
        //Z_ASSERT_ERROR(scast_z(eValue, unsigned int) < ENormalizationForm::_GetNumberOfValues(), "The enumeration value is not valid.");
...
private:
    ...
    /// </summary>
    static const ENormalizationForm::EnumType sm_arValues[];

    /// <summary>
    /// The contained enumeration value.
    /// </summary>
    ENormalizationForm::EnumType m_value;

};

} // namespace z

#endif // __ENORMALIZATIONFORM__
