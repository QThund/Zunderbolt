...
/// </returns>
Z_COMMON_MODULE_SYMBOLS void* operator new (const size_t uSize, const z::Alignment& alignment);
...
/// <param name="pMemoryBlock">[IN] Pointer to the aligned memory block to be deallocated.</param>
/// <param name="alignment">[IN] The data alignment value (must be always a power of two).</param>
Z_COMMON_MODULE_SYMBOLS void operator delete (void* pMemoryBlock, const z::Alignment& alignment);
