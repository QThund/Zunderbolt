...
template class Z_MATH_MODULE_SYMBOLS BaseTriangle<Vector2>;
template class Z_MATH_MODULE_SYMBOLS BaseTriangle<Vector3>;
template class Z_MATH_MODULE_SYMBOLS BaseTriangle<Vector4>;
