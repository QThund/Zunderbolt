...
/// <remarks>
class Z_LAYER_MATH_SYMBOLS Matrix3x4 : public BaseMatrix3x4
{
    // FRIENDS
    // ---------------
public:
    ...
    /// </returns>
    friend Matrix3x4 Z_LAYER_MATH_SYMBOLS operator*(const float_z fScalar, const Matrix3x4 &matrix);
...
public:
    ...
    Matrix3x4(const BaseMatrix3x4 &matrix);
...
public:
    ...
    /// </returns>
    BaseMatrix3x3 operator*(const BaseMatrix4x3& matrix) const;
    ...
    /// </returns>
    Matrix3x4 operator*(const BaseMatrix4x4& matrix) const;
    ...
    /// The resultant matrix.
    /// </returns>
    Matrix3x4 operator+(const BaseMatrix3x4 &matrix) const;
    ...
    /// The modified matrix.
    /// </returns>
    Matrix3x4& operator+=(const BaseMatrix3x4 &matrix);
    ...
    /// The modified matrix.
    /// </returns>
    Matrix3x4& operator*=(const BaseMatrix4x4 &matrix);
