...
template class Z_LAYER_MATH_SYMBOLS Triangle<Vector2>;
template class Z_LAYER_MATH_SYMBOLS Triangle<Vector3>;
template class Z_LAYER_MATH_SYMBOLS Triangle<Vector4>;
