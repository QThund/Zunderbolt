...
#ifndef __BASEMATRIX4X4__
#define __BASEMATRIX4X4__
...
/// </summary>
class Z_MATH_MODULE_SYMBOLS BaseMatrix4x4
{
    // CONSTRUCTORS
    // ---------------
public:
    ...
    explicit BaseMatrix4x4(const float_z fValueAll);
    ...
    BaseMatrix4x4(const float_z f00, const float_z f01, const float_z f02, const float_z f03,
    ...
    /// is undefined.</param>
    explicit BaseMatrix4x4(const float_z* arValues);
    ...
    BaseMatrix4x4(const vf32_z row0, const vf32_z row1, const vf32_z row2, const vf32_z &row3);
...
public:
    ...
    /// </returns>
    bool operator==(const BaseMatrix4x4 &matrix) const;
