...
template class Z_MATH_MODULE_SYMBOLS BaseOrb<Vector2>;
template class Z_MATH_MODULE_SYMBOLS BaseOrb<Vector3>;
template class Z_MATH_MODULE_SYMBOLS BaseOrb<Vector4>;
