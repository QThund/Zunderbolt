...
#ifndef __ZMATHMODULEDEFINITIONS__
#define __ZMATHMODULEDEFINITIONS__
...
#ifdef Z_PREPROCESSOR_EXPORTLIB_MATH // Specified as a preprocessor definition when compiling as a dynamic link library
    #define Z_MATH_MODULE_SYMBOLS Z_EXPORT_SYMBOLS
    #define Z_MATH_MODULE_EXTERN Z_EXPORT_SYMBOLS_EXTERN
    #define Z_MATH_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_MATH_MODULE_IS_DYNAMIC 1
#elif defined(Z_PREPROCESSOR_IMPORTLIB_MATH) || defined(Z_PREPROCESSOR_IMPORTLIB_ZUNDERBOLT) // Specified as a preprocessor definition when compiling the client system
    #define Z_MATH_MODULE_SYMBOLS Z_IMPORT_SYMBOLS
    #define Z_MATH_MODULE_EXTERN Z_IMPORT_SYMBOLS_EXTERN
    #define Z_MATH_MODULE_TEMPLATE_SPECIALIZATION_SYMBOLS
    #define Z_MATH_MODULE_IS_DYNAMIC 1
#else // Static library
    #define Z_MATH_MODULE_SYMBOLS
    #define Z_MATH_MODULE_EXTERN
    #define Z_MATH_MODULE_IS_STATIC 1
#endif


#endif // __ZMATHMODULEDEFINITIONS__
