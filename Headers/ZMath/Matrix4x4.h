...
/// </remarks>
class Z_MATH_MODULE_SYMBOLS Matrix4x4
{
    // FRIENDS
    // ---------------
public:
...
public:
    ...
    explicit Matrix4x4(const float_z fValueAll);
    ...
    Matrix4x4(const float_z f00, const float_z f01, const float_z f02, const float_z f03,
    ...
    /// is undefined.</param>
    explicit Matrix4x4(const float_z* arValues);
    ...
    Matrix4x4(const vf32_z row0, const vf32_z row1, const vf32_z row2, const vf32_z &row3);
...
public:
    ...
    /// </returns>
    static const Matrix4x4& GetNullMatrix();
...
public:
    ...
    /// <summary>
    /// Multiplies a Matrix4x4 by the current matrix.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Adds a Matrix4x4 to the current matrix.
    /// </summary>
    ...
    /// <summary>
    /// Subtracts a Matrix4x4 to the current matrix.
    /// </summary>
