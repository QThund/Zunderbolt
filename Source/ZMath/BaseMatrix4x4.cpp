...
BaseMatrix4x4::BaseMatrix4x4()
{
    ij[0][0] = ij[0][1] = ij[0][2] = ij[0][3] =
    ij[1][0] = ij[1][1] = ij[1][2] = ij[1][3] =
    ij[2][0] = ij[2][1] = ij[2][2] = ij[2][3] =
    ij[3][0] = ij[3][1] = ij[3][2] = ij[3][3] = SFloat::_0;
}

BaseMatrix4x4::BaseMatrix4x4(const BaseMatrix4x4 &matrix)
{
    memcpy(this->ij, matrix.ij, sizeof(float_z) * 16);
}

BaseMatrix4x4::BaseMatrix4x4(const float_z fValueAll)
{
    ij[0][0] = ij[0][1] = ij[0][2] = ij[0][3] =
    ij[1][0] = ij[1][1] = ij[1][2] = ij[1][3] =
    ij[2][0] = ij[2][1] = ij[2][2] = ij[2][3] =
...
BaseMatrix4x4::BaseMatrix4x4(const float_z f00, const float_z f01, const float_z f02, const float_z f03,
...
BaseMatrix4x4::BaseMatrix4x4(const float_z* arValues)
{
...
BaseMatrix4x4::BaseMatrix4x4(const vf32_z row0, const vf32_z row1, const vf32_z row2, const vf32_z &row3)
{
...
bool BaseMatrix4x4::operator==(const BaseMatrix4x4 &matrix) const
{
