...
BaseMatrix3x3::BaseMatrix3x3()
{
    ij[0][0] = ij[0][1] = ij[0][2] = SFloat::_0;
    ij[1][0] = ij[1][1] = ij[1][2] = SFloat::_0;
    ij[2][0] = ij[2][1] = ij[2][2] = SFloat::_0;
}

BaseMatrix3x3::BaseMatrix3x3(const BaseMatrix3x3 &matrix)
{
    memcpy(this->ij, matrix.ij, sizeof(float_z) * 9);
}

BaseMatrix3x3::BaseMatrix3x3(const float_z fValueAll)
{
...
BaseMatrix3x3::BaseMatrix3x3(const float_z f00, const float_z f01, const float_z f02,
...
BaseMatrix3x3::BaseMatrix3x3(const float_z* arValues)
{
...
BaseMatrix3x3::BaseMatrix3x3(const vf32_z row0, const vf32_z row1, const vf32_z row2)
{
    float_z fAux;
...
bool BaseMatrix3x3::operator==(const BaseMatrix3x3 &matrix) const
{
